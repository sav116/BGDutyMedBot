...
def who_duty_dev():
    from loader import GOOGLE_DEV_SHEET_CUR_MONTH, DATA_DEV
    ...
    if now.date() == cell_data_value.date():
        for row in range(2, 43):
            ...
            if color == "FF4A86E8":
                counter += 1
            if counter == parse_mode and color == "FF0000FF":
                ...
                if ',' not in duty_fio:
                    ...
                    duty_nick = get_nic_telegramm_dev(surname, GOOGLE_DEV_SHEET_CUR_MONTH)
                    ...
                    duty_nick_1 = get_nic_telegramm_dev(surname_1, GOOGLE_DEV_SHEET_CUR_MONTH)
                    ...
                    duty_nick_2 = get_nic_telegramm_dev(surname_2, GOOGLE_DEV_SHEET_CUR_MONTH)
